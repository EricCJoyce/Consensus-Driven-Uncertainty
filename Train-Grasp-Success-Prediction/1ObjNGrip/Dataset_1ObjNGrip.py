...
'''
Class for a dataset for a single object and both grippers.
'''
class Dataset_1ObjNGrip(Dataset):
	def __init__(self, files):
		...
		self.one_hot_length = len(self.grippers_encountered)		#  Lock down the length of the one-hot sub-vector.
		...
		for file in files:											#  SECOND pass: encounter ALL OBJECTS IN SET DETERMINED BY "files".
			...
			for line in lines:
				...
				one_hot_vector[ self.grippers_encountered.index( gripper ) ] = 1.0
